  ...
  return (
    ...
    <div className="col p-3 add-bottom-margin">
      ...
      <Row className="mb-4">
        <Form.Group as={Col} controlId="reply_to" >
          <Form.Control  onChange={handleChange} value={toSend.reply_to} name='reply_to' type="email" placeholder="Your Email*" required />
        </Form.Group>

        <Form.Group as={Col} controlId="from_name">
          <Form.Control name='from_name'required value={toSend.from_name} onChange={handleChange} placeholder="Your Name*" />
        </Form.Group>
      </Row>

      <Form.Group className="mb-4" controlId='subject'>
        <Form.Control value={toSend.subject} required onChange={handleChange} name="subject" placeholder="Subject*" />
      </Form.Group>

      <Form.Group className="mb-3" controlId='message' >
        <Form.Control required onChange={handleChange} type="text" value={toSend.message} name="message" as="textarea" rows={3} placeholder="Your Message*" />
      </Form.Group>
    <Col className='d-flex justify-content-center align-items-center'>
      ...
      <>
          ...
          <BsIcons.BsCheckLg style={{color:"green"}} className="ms-2"></BsIcons.BsCheckLg>
          </>
       :
